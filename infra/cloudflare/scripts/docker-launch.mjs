...
const reactModulesVolume = 'brokerage-onboarding-react-node-modules'
...
const runArgs = [
  ...
  '-v', `${cloudflareModulesVolume}:/workspace/infra/cloudflare/node_modules`,
  '-v', `${reactModulesVolume}:/workspace/react/node_modules`,
