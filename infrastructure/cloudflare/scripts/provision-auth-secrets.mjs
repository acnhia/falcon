...
import { edgeWorkerPath, wranglerPath, envPath, parseEnvironment, required, setEnvironmentValues } from './cloudflare-client.mjs'
...
for (const [name, value] of [
  ...
  const result = spawnSync('npx', ['wrangler', 'secret', 'put', name, '--config', wranglerPath], {
    cwd: edgeWorkerPath,
    input: value,
